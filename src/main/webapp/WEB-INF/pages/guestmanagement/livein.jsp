...
<!--       		</tr> -->
      		...
      		<tr>
      			<td>证件号</td>
      			<td><input type="text" id="certificatenum" class="am-form-field am-radius" placeholder="证件号" maxlength="20" required name="certificatenum" /></td>
      		</tr>
      		<tr>
      			<td>押金</td>
...
<!--       				<input type="text" class="am-form-field am-radius" placeholder="会员类型" name="membertype"> -->
      		...
      		<tr>
      			<td>手机号</td>
      			<td><input type="number" class="am-form-field am-radius" placeholder="手机号"  name="ex2" maxlength="11" minlength="11"></td>
      		</tr>
      	
      		<tr>
      			<td>备注</td>
      			<td><textarea type="text" class="am-form-field am-radius" placeholder="备注" maxlength="200" name="note"></textarea></td>
      		</tr>
<!--       		<tr> -->
...
// 	    	var certificatetype = $(this).find("option:selected").text();
	    	var certificatetype = $('#certificatetype option:selected').val();
...
// 					alert(certificatetype);
					$.ajax({
						...
						"type":"post",
						"data":{"certificatenum":certificatenum,"certificatetype":certificatetype},
						"async":true,
						"dateType":"json",
						"success":function(res){
							if(res){
