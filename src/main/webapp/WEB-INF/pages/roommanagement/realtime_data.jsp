...
<head>
    ...
    <title>实时房态图</title>
    <meta name="description" content="实时房态图">
...
<div class="admin-biaogelist" style="position: static;">
    ...
    <div class="listbiaoti am-cf">
        <ul><img style="margin:-5px 5px 0px 0px;" src="<c:url value='/img/index/menu0.png'/>">实时房态图</ul>

        <dl class="am-icon-home" style="float: right;">当前位置： <a href='${pageContext.request.contextPath}/mainPage.action' >首页</a> > <a href="#">实时房态图</a></dl>
...
<!-- 					</select> -->
					...
					<select class="xlk-quq"  id="areaId" name="floor" >
						<option value="">房间楼层</option> -->
    					<c:forEach items="${floors}" var="floora">
       			 			<option value="${floora}" <c:if test="${floor eq floora}">selected="selected"</c:if> >${floora}</option>
    					</c:forEach>
					</select>
