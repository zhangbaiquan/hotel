...
<title>留言板</title>
<meta name="description" content="这是一个留言板添加页面">
...
<body>
    <div class="listbiaoti am-cf">
      <ul><img style="margin:-5px 5px 0px 0px;" src="<c:url value='/img/index/menu8.png'/>"> 留言板</ul>
...
<div class="fbneirong" >
<form style="width: 100%" class="am-form" data-am-validator action="<c:url value='/msgboard/msgboardAdd.action'/>" method="post">
  
  <table class="am-table am-table-bordered">
      		<tr>
      			<td width="10%">姓名</td>
      			<td width="90%" ><input type="text" class="am-form-field am-radius" placeholder="您的姓名" maxlength="20" minlength="1" required name="msgboardname" /></td>
      		</tr>
...
<!--       		</tr> -->
      		<tr>
      			<td>联系方式</td>
      			<td><input type="number"  class="am-form-field am-radius" placeholder="请写下您的联系方式" name="msgboardphone" ></textarea></td>
      		</tr>
      		<tr>
      			<td>留言区</td>
      			<td><textarea rows="" cols=""  class="am-form-field am-radius" placeholder="请写下您的留言内容" name="ex1" maxlength="200"></textarea></td>
      		</tr>
